...
function FormPage() {
    ...
    useEffect(() => console.log(plan, yearly, addOns)
    ,[plan, yearly, addOns])
    ...
    return (
        <div className="flex flex-col mx-2">
            ...
            <div className="flex flex-col lg:flex-row bg-white rounded-lg p-6 lg:p-4 mx-2 mt-[6.125rem] lg:mt-0 shadow-lg gap-y-14 lg:gap-y-0 lg:min-w-[57.75rem]"> {/* form card */}
